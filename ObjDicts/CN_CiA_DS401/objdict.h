...
EPL_OBD_BEGIN ()
    ...
    EPL_OBD_BEGIN_PART_GENERIC ()
        ...
        EPL_OBD_BEGIN_INDEX_RAM(0x1600, 0x05, EplPdouCbObdAccess)
        ...
        EPL_OBD_BEGIN_INDEX_RAM(0x1601, 0x05, EplPdouCbObdAccess)
        ...
        EPL_OBD_BEGIN_INDEX_RAM(0x1602, 0x05, EplPdouCbObdAccess)
        ...
        EPL_OBD_BEGIN_INDEX_RAM(0x1A00, 0x05, EplPdouCbObdAccess)
    ...
    EPL_OBD_BEGIN_PART_DEVICE ()
        ...
        EPL_OBD_BEGIN_INDEX_RAM(0x6401, 0x05, NULL)
        ...
        EPL_OBD_BEGIN_INDEX_RAM(0x6402, 0x05, NULL)
        ...
        EPL_OBD_BEGIN_INDEX_RAM(0x6411, 0x05, NULL)
        ...
        EPL_OBD_BEGIN_INDEX_RAM(0x6412, 0x05, NULL)
